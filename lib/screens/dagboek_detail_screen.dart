      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _MetricRij(naam: 'Eczeem', waarde: metric.eczeemErnstig, kleur: Colors.red),
            const SizedBox(height: 6),
            Padding(
              padding: const EdgeInsets.only(left: 4),
              child: Text('Symptomen', style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: Colors.grey[600])),
            ),
            const SizedBox(height: 4),
            _MetricRij(naam: 'Jeuk', waarde: metric.eczeemJeuken, kleur: Colors.orange[400]!),
            const SizedBox(height: 4),
            _MetricRij(naam: 'Roodheid', waarde: metric.roodheid, kleur: Colors.red[400]!),
            const SizedBox(height: 4),
            _MetricRij(naam: 'Droogheid', waarde: metric.droogheid, kleur: Colors.lightBlue[400]!),
            const SizedBox(height: 4),
            _MetricRij(naam: 'Schilfering', waarde: metric.schilfering, kleur: Colors.brown[300]!),
            const SizedBox(height: 8),
